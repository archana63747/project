...
<body>
    <header>
        <div class="header-content">
            ...
            <img src=".Archana N.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>archana</h1>
            <p> i am in student</p>
        </div>
    </header>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p> hellow everyone this is Archana N and i am  computer science student my ambition police officer  </p>
        </div>
    </section>
